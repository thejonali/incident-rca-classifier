...
DEFAULT_HARD_CASES_PATH = PROJECT_ROOT / "data" / "evaluation" / "hard_cases.json"
DEFAULT_REAL_WORLD_HARD_CASES_PATH = PROJECT_ROOT / "data" / "evaluation" / "real_world_hard_cases.json"
